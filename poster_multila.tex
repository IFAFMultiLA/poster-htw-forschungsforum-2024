...
\veryHuge \color{NavyBlue} \textbf{Die Softwareplattform MultiLA}\\[0.4cm] % Title
\Huge\textbf{\textit{Authoring Software \& Learning Analytics für interaktive \mbox{Lernanwendungen} in Statistik \& Data Science}}\\[2cm] % Subtitle
\color{Black}
\huge Markus Konrad MSc.\textsuperscript{1,2},
Prof. Dr. Maria Osipenko\textsuperscript{2},
Prof. Dr. Martin Spott\textsuperscript{1},
Prof.~Dr.~Andre Beinrucker\textsuperscript{1}\\[0.7cm] % Author(s)
...
%\captionof*{figure}{\footnotesize TODO oder weg}
...
% Sämtliche Apps wurden bereits in der Lehre eingesetzt.
